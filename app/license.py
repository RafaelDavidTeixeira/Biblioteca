...
# Chave fixa HMAC — usada apenas para assinar/verificar chaves de licença.
# É hardcoded propositalmente para que Biblioteca.exe e GeradorLicenca.exe
# usem o mesmo segredo independentemente de config_manager / instance/config.json.
# NÃO é usada para criptografia de dados, apenas assinatura.
