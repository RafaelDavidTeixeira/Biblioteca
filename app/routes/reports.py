...
def report_inventory():
    try:
        ...
        logging.error(f"Erro inventory: {e}\n{traceback.format_exc()}")
...
@bp.route('/api/reports/reservations')
@auth_required
def report_reservations():
    status = request.args.get('status', 'active')
    return jsonify(services.get_reservations_report(status))


@bp.route('/api/reports/reservation-stats')
@auth_required
def report_reservation_stats():
    return jsonify(services.get_reservation_stats())
